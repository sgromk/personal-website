        ...
        <div className="grid md:grid-cols-[1fr_300px] gap-12 items-center">
          ...
          <div className="space-y-8">
            ...
            <div className="flex gap-4 pt-8 text-zinc-500">
              ...
              <a href="/cv" className="hover:text-zinc-300 transition-colors text-sm font-medium">
                CV
              </a>
            </div>
          </div>
          ...
          <div className="hidden md:block">
            <div className="w-[300px] h-[300px] rounded-lg border-2 border-zinc-800 overflow-hidden">
              <Image
                src="/headshot.jpg"
                alt="Gabriel Kinshuk"
                width={300}

    ...
    <div className="min-h-screen bg-[#0d1117]">
      <div className="container mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 py-20">
        ...
        <div className="space-y-8">
          <div>
            <h1 className="text-4xl font-bold text-zinc-100 mb-2">Protein Parser</h1>
            <div className="h-1 w-16 bg-blue-500 mb-6" />
          </div>

          <div className="space-y-6 text-zinc-400">
            <p>
              Bioinformatics tool for parsing and analyzing protein sequence data with structural validation.
            </p>
